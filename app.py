...
def _run_apply_job(job_id, fixes_data):
    ...
    for filepath, file_fixes in fixes_by_file.items():
        ...
        prompt = (
            ...
            f"- For Stage 1 specifically: in the Stage 1 HTML template, remove the 'Proceed to Stage 2' button/link entirely and replace it with a message: 'This entry point has been secured. The CTF begins at Stage 2.'\n\n"
